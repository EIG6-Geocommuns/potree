...
var LAZLoader = function(arraybuffer) {
	...
	let workerPath = Globals.scriptPath + "/workers/LASLAZWorker.js";
	this.ww = Globals.workerPool.getWorker(workerPath);
...
LAZLoader.prototype.close = function() {
	...
	return new Promise(function(res, rej) {
		o.dorr({type:'close'}, function(r) {
			let workerPath = Globals.scriptPath + "/workers/LASLAZWorker.js";
			Globals.workerPool.returnWorker(workerPath, o.ww);
